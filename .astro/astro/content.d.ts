...
declare module 'astro:content' {
	...
	type ContentEntryMap = {
		"articles": {
"m-shaped-career.md": {
	id: "m-shaped-career.md";
  slug: "m-shaped-career";
  body: string;
  collection: "articles";
  data: InferEntrySchema<"articles">
} & { render(): Render[".md"] };
"speech-ai-access.md": {
	id: "speech-ai-access.md";
  slug: "speech-ai-access";
  body: string;
  collection: "articles";
  data: InferEntrySchema<"articles">
} & { render(): Render[".md"] };
...
"astrology-framework.md": {
	id: "astrology-framework.md";
  slug: "astrology-framework";
  body: string;
  collection: "notes";
  data: InferEntrySchema<"notes">
} & { render(): Render[".md"] };
"coordination-tax.md": {
	id: "coordination-tax.md";
